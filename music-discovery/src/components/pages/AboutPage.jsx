    ...
    <div className="about-page">
      <div className="about-container">
        ...
        <section>
          ...
          <p>
              SongScout is hear to provide an algorithm-free resource for discovering artists
        ...
        <section className="about-full-width">
          ...
          <p>
              In a world filled with tailored content, SongScout was created to keep every user's
